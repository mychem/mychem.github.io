...
-  Ernst-Georg Schmid - Pgchem lead developer
   ...
   `Pgchem <http://pgfoundry.org/projects/pgchem/>`__ is a
   chemoinformatics extension for PostgreSQL developed by Ernst-Georg
   Schmid. We have decided that Mychem Project should have the same
   functions as Pgchem. Of course, we are sharing our knowledge on Open
   Babel, Relational Database and extension programing.
...
Mychem is free software; you can redistribute it and/or modify it under
